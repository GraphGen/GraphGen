...
class Args:
    ...
    def __init__(self):
        ...
        # Algorithm Version - GraphRNN  | DFScodeRNN (GraphGen) | DeepGMG
        self.note = 'DFScodeRNN'
        
        # Check utils for datasets | Add _inactive and _active with chemical compounds if you want specific category
        ...
        self.embedding_size_timestamp_output = 512 # the size for vertex output embedding
        ...
        self.gamma = 0.3 # Learning rate decay factor at each milestone (no. of epochs)
        ...
        self.dataset_path = self.dir_input + 'dataset/'
        self.temp_path = self.dir_input + 'temp/'

        # Model save and validate parameters
        self.save_model = True
        self.epochs_save = 20 # Save epochs every epoch_save epochs
        self.epochs_validate = 1 # Compute validate loss every epochs_validate epoch
        ...
        self.load_model_path = None # Path to saved model
