...
import torch
from train_graph_rnn import predict_graphs as gen_graphs_graph_rnn
from train_dfscode_rnn import predict_graphs as gen_graphs_dfscode_rnn
from dgmg.train_dgmg import predict_graphs as gen_graphs_dgmg
...
class ArgsEvaluate():
    def __init__(self):
        ...
        self.model_path = './model_save/' + 'DFScodeRNN_Lung_inactive_2019-10-19 06:56:57/' + \
                                'DFScodeRNN_Lung_inactive_1.dat'
...
if __name__ == "__main__":
    ...
    print('Evaluating {}, run at {}, epoch {}'.format(train_args.fname, train_args.time, eval_args.num_epochs))
    ...
    graphs_test_indices = graphs[int(0.9 * len(graphs)):]
    graphs_train_indices = graphs[:int(0.8 * len(graphs))]
    ...
    degree_mmd, clustering_mmd, orbit_mmd, nspdk_mmd = [], [], [], [0]
